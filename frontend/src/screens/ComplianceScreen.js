...
const ComplianceScreen = ({ history, match }) => {
                        ...
                        <Row>
                          <Col md={4}>
                            <p>
                              ...
                              {`N${numberComma(
                                contributor?.investments[0].investmentAmount
                              )}`}
                            </p>
                          </Col>
                          <Col md={4}>
                        ...
                        <Row>
                          <Col md={4}>
                            <p>
                              ...
                              {`N${numberComma(
                                contributor.investments[0].totalAmountInvested
                              )}`}
                            </p>
                          </Col>
                          <Col md={4}>
                        ...
                        <Row>
                          <Col md={4}>
                            {contributor.investments !== undefined && (
                              ...
                              >
                                <Button block>All TopUps</Button>
                              </LinkContainer>
                            )}
                          </Col>
